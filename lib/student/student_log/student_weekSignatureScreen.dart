...
class SignatureScreen extends StatefulWidget {
  ...
  final String week;
  final String day;
  SignatureScreen({required this.IpAddress, required this.candidate_table, required this.week, required this.day });
  @override
  ...
  Future<void> _uploadSignature() async {
    ...
    try{
      ...
      if (data == null) throw Exception("Could not capture signature");
        ...
        var urlDataSend = "http://${IpAddress}/project_app/student_book_media.php";
