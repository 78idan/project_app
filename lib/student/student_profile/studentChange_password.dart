...
// void main(){
//   runApp(
//     student_changePassword1_1()
//   );
// }

// class student_changePassword1_1 extends StatelessWidget{
//   @override  
//   Widget build(BuildContext context ){
//     return MaterialApp(
//       debugShowCheckedModeBanner: false,
//       home: student_changePassword1_2(),
//     );
//   }
// }
...
class student_changePassword1_2 extends StatefulWidget{
    final String IpAddress;
    final String  admission_number ;
    student_changePassword1_2({ required this.IpAddress, required this.admission_number  });
  @override  
  student_changePassword1_3 createState()=> student_changePassword1_3();
}


class student_changePassword1_3 extends State<student_changePassword1_2>{
  @override  
  Widget build(BuildContext context ){
    return Scaffold(
      backgroundColor: Color(0xFF002147),
      appBar: student_changePasswordAppBar(context),
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              student_changePasswordTextField1_1(IpAddress: widget.IpAddress, admssion_number: widget.admission_number,)
            ],
          ),
        ),
      ),
...
PreferredSizeWidget student_changePasswordAppBar(BuildContext context){
  return AppBar(
    backgroundColor: Color(0xFF002147),
    leading: IconButton(
      onPressed: (){
...
class student_changePasswordTextField1_1 extends StatefulWidget{
      final String IpAddress;
      final String  admssion_number ;
  student_changePasswordTextField1_1({ required this.IpAddress, required this.admssion_number });
  @override  
  student_changePasswordTextField1_2 createState()=> student_changePasswordTextField1_2();
}

class student_changePasswordTextField1_2 extends State<student_changePasswordTextField1_1>{
  ...
  TextEditingController studentAdmissionNumber = TextEditingController();
