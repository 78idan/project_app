...
import 'package:project_app/home/reset_password.dart';
...
// class verifyCode1_1 extends StatelessWidget{
//   @override  
...
class verifyCode1_2 extends StatefulWidget{

  final String IpAddress;
  final String email;

  verifyCode1_2({ required this.IpAddress, required this.email });

  @override  
  verifyCode1_3 createState()=> verifyCode1_3();
}


class verifyCode1_3 extends State<verifyCode1_2>{
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  verifyText1_1(onloading: setLoading, IpAddress: widget.IpAddress, email: widget.email, )
                ],
              ),
            ),
          ),
...
PreferredSizeWidget verifyAppBar(BuildContext context ){
  return AppBar(
    backgroundColor: Color(0xFF002147),
    leading: IconButton(
      onPressed: (){
...
class verifyText1_1 extends StatefulWidget{
    final Function(bool) onloading;
    final String IpAddress;
    final String email;
  verifyText1_1({required this.onloading, required this.IpAddress, required this.email  });
  @override  
  verifyText1_2 createState()=> verifyText1_2();
}

class verifyText1_2 extends State<verifyText1_1>{
  final keyVerifyForm = GlobalKey<FormState>();
  ...
  //starting of function to validation
  ...
  //ending of function to validation
  ...
  Future<void> verifyOtp() async {
    ...
    try{
      ...
      var url = "http://$ipAddress/project_app/verify_code.php";
      ...
      if(response.statusCode == 200){
        ...
        if (fetchedData['message'] == "otp matches" ){
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => resetPassword1_2(IpAddress: widget.IpAddress, email: email),
            )
          );
