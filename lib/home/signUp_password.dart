...
// class signUp_Password1_1 extends StatelessWidget{
//   @override  
//   Widget build(BuildContext context ){
//     return MaterialApp(
//       debugShowCheckedModeBanner: false,
//       home: signUp_Password1_2(),
//     );
//   }
// }

class signUp_Password1_2 extends StatefulWidget{
  final String IpAddress;
  final String email;

  signUp_Password1_2({ required this.IpAddress, required this.email });

  @override  
  signUp_Password1_3 createState()=> signUp_Password1_3();
}

class signUp_Password1_3 extends State<signUp_Password1_2>{
    ...
    return Stack(
      children: [
        Scaffold(
          ...
          appBar: signUp_PasswordAppBar(context),
          body: Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  signUp_PasswordText1_1(IpAddress: widget.IpAddress,email: widget.email, onloading: setLoading, ),
                ],
              ),
            ),
          ),
...
PreferredSizeWidget signUp_PasswordAppBar(BuildContext context ){
  return AppBar(
    backgroundColor: Color(0xFF002147),
    leading: IconButton(
      onPressed: (){
...
class signUp_PasswordText1_1  extends StatefulWidget{
  final String IpAddress;
  final String email;
  final Function(bool) onloading;
  signUp_PasswordText1_1({ required this.IpAddress, required this.email, required this.onloading});
  @override  
  signUp_PasswordText1_2 createState()=> signUp_PasswordText1_2();
}

class signUp_PasswordText1_2 extends State<signUp_PasswordText1_1>{
  final keysignUpPasswordText = GlobalKey<FormState>();
  ...
  void initState(){
     ...
     passwordContoller.addListener((){
        setState(() {
          has8Characters = passwordContoller.text.length >= 8;
          hasSpecialCharacters = passwordContoller.text.contains(RegExp(r'[!@#$%^&*(),.?":{}|<>]'));
        });
      }
    ); 
  }
  ...
  Future<void> sendingPassword() async{
    ...
    try{
      ...
      var url = "http://$ipAddress/project_app/signUp_password.php";
      var passwordData = {
        "email": email,
