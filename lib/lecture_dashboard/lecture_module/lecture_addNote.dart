...
class lecture_addNote1_2 extends StatefulWidget{
  final String module_name;
  final String IpAddress;
  lecture_addNote1_2({ required this.module_name, required this.IpAddress  });  
  @override  
  lecture_addNote1_3 createState()=> lecture_addNote1_3();
}


class lecture_addNote1_3 extends State<lecture_addNote1_2>{
  @override  
  Widget build(BuildContext context ){
    return Scaffold(
      backgroundColor: Color(0xFF002147),
      appBar: lecture_addNoteAppBar(context),
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              lecture_addNoteTextField1_1(module_name: widget.module_name, IpAddress: widget.IpAddress)
            ],
          ),
        ),
      ),
...
PreferredSizeWidget lecture_addNoteAppBar(BuildContext context){
  return AppBar(
    elevation: 0,
    backgroundColor: Color(0xFF002147),
    leading: IconButton(
...
class lecture_addNoteTextField1_1 extends StatefulWidget{  
  final String module_name;
  final String IpAddress;
  lecture_addNoteTextField1_1({ required this.module_name, required this.IpAddress  });  
  @override  
  lecture_addCourseTextField1_2 createState()=> lecture_addCourseTextField1_2();
}

class lecture_addCourseTextField1_2 extends State<lecture_addNoteTextField1_1>{
  ...
  Future<void> sendNote() async {
    ...
    try{
      ...
      var UrlSend = "http://${IpAddress}/project_app/addNote.php";
