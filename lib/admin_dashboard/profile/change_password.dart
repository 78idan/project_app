...
class changePassword1_2 extends StatefulWidget{
    final String IpAddress;
    final String  admission_number ;
    changePassword1_2({ required this.IpAddress, required this.admission_number  });
  @override  
  changePassword1_3 createState()=> changePassword1_3();
}


class changePassword1_3 extends State<changePassword1_2>{
  @override  
  Widget build(BuildContext context ){
    return Scaffold(
      backgroundColor: Color(0xFF002147),
      appBar: changePasswordAppBar(context),
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              changePasswordTextField1_1(IpAddress: widget.IpAddress, admssion_number: widget.admission_number,)
            ],
          ),
        ),
      ),
...
PreferredSizeWidget changePasswordAppBar(BuildContext context){
  return AppBar(
    backgroundColor: Color(0xFF002147),
    leading: IconButton(
      onPressed: (){
...
class changePasswordTextField1_1 extends StatefulWidget{
      final String IpAddress;
      final String  admssion_number ;
  changePasswordTextField1_1({ required this.IpAddress, required this.admssion_number });
  @override  
  changePasswordTextField1_2 createState()=> changePasswordTextField1_2();
}

class changePasswordTextField1_2 extends State<changePasswordTextField1_1>{
